...
//     type: 'http',
//     category: 'xhr',
//     data: { url: 'https://www.brc.ac.uk/icpveg/api/v1/samples' },
//   },
//   {
//     timestamp: 1518983935.123,
//     type: 'http',
//     category: 'xhr',
//     data: { url: 'https://www.brc.ac.uk/icpveg/api/v1/users/USERID' },
//   },
//   {
...
describe('Helpers Analytics', () => {
  ...
  describe('breadcrumbCallback', () => {
    it('should remove userId from ajax URLs', () => {
      const crumb = {
        ...
        type: 'http',
        category: 'xhr',
        data: { url: 'https://www.brc.ac.uk/icpveg/api/v1/users/ty%40uk2' },
      };

      const resultCrumb = breadcrumbCallback(crumb);

      expect(resultCrumb.data.url).to.equal(
        'https://www.brc.ac.uk/icpveg/api/v1/users/USERID'
      );
    });
    ...
    it('should not save image GETs', () => {
      const crumb = {
        ...
        data: {
          method: 'GET',
          url: 'file:///data/user/0/uk.ac.ceh.icpveg/files/1471447312788.jpeg',
        },
      };
      const resultCrumb = breadcrumbCallback(crumb);
      expect(resultCrumb.data.url).to.be.eql(
        'file:///data/user/0/uk.ac.ceh.icpveg/files/FILENAME.jpeg'
      );
    });
  });
      ...
      const values = [
        ...
        },
        {
          ...
          data: {
            method: 'GET',
            url:
              'file:///data/user/0/uk.ac.ceh.icpveg/files/1471447312788.jpeg',
          },
        },
        {
          ...
          data: {
            method: 'GET',
            url:
              'file:///data/user/0/uk.ac.ceh.icpveg/files/1471447312789.jpeg',
          },
        },
        {
          timestamp: 1518983845.562,
  ...
  describe('removeUserId', () => {
    it('should remove user id from the URL', () => {
      const URL = 'https://www.brc.ac.uk/icpveg/api/v1/users/ty%40uk2';
